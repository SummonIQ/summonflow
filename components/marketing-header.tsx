...
const publicRepoUrl = "https://github.com/SummonIQ/summon-flow";
...
export function MarketingHeader() {
  ...
  const innerShellClass =
    headerVariant === "minimal"
      ? "relative mx-auto flex w-full max-w-7xl items-center justify-center gap-4 px-6 pt-7 pb-4 sm:px-10"
      : headerVariant === "framed"
        ? "relative mx-auto mt-3 flex w-full max-w-7xl items-center justify-center gap-4 rounded-full border border-[color:color-mix(in_srgb,var(--foreground)_8%,transparent)] bg-[color:color-mix(in_srgb,var(--panel)_60%,transparent)] px-6 pt-7 pb-4 shadow-[0_12px_50px_-32px_rgba(0,0,0,0.28)] sm:px-8"
        : headerVariant === "accent"
          ? "relative mx-auto mt-3 flex w-full max-w-7xl items-center justify-center gap-4 rounded-full border border-[color:color-mix(in_srgb,var(--teal)_16%,transparent)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--panel)_74%,transparent),color-mix(in_srgb,var(--panel)_56%,transparent))] px-6 pt-7 pb-4 shadow-[0_18px_64px_-36px_rgba(7,54,58,0.34)] sm:px-8"
          : "relative mx-auto flex w-full max-w-7xl items-center justify-center gap-4 px-6 pt-7 pb-4 sm:px-10";

  const sideRailClass =
    headerVariant === "default" || headerVariant === "minimal"
      ? "top-[calc(50%+0.375rem)] -translate-y-1/2 sm:left-10"
      : "top-[calc(50%+0.375rem)] -translate-y-1/2 sm:left-8";
  const actionRailClass =
    headerVariant === "default" || headerVariant === "minimal"
      ? "top-[calc(50%+0.375rem)] -translate-y-1/2 sm:right-10"
      : "top-[calc(50%+0.375rem)] -translate-y-1/2 sm:right-8";
      ...
      <div className="relative">
        ...
        <div className="relative z-10 w-full border-b border-transparent">
          <div className={innerShellClass}>
            <Link
              href="/"
              className={`absolute left-6 text-[var(--foreground)] ${sideRailClass}`}
            >
              <BrandWordmark />
            </Link>
            ...
            <div className={`absolute right-6 flex items-center gap-3 ${actionRailClass}`}>
