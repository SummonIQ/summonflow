...
export const metadata: Metadata = {
  title: "Changelog",
  description:
    "SummonFlow changelog — new features, improvements, and fixes for the realtime infrastructure platform.",
  alternates: { canonical: "https://summonflow.com/changelog" },
};
    ...
    <main className="page-shell min-h-screen px-6 py-10 sm:px-10">
      <div className="mx-auto max-w-[76rem]">
        <div className="max-w-3xl">
          <h1 className="font-[var(--font-heading)] text-4xl font-bold tracking-tight sm:text-5xl">Changelog</h1>
