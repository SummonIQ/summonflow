  ...
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <section className="space-y-6">
        ...
        <h3 className="text-lg font-semibold text-white mt-8">1. Install the OSS packages</h3>
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-xs">
          ...
          <div className="mt-2 text-zinc-500 italic"># install the OSS server package from its standalone distribution</div>
        </div>
          ...
          <ol className="space-y-6 text-sm text-zinc-400">
            <li className="flex gap-4">
              ...
              <div>
                ...
                <div className="mt-1">Sign up at <Link href="/signup" className="text-teal-500 hover:underline">summonflow.com/signup</Link> &mdash; the Hobby tier is free.</div>
              </div>
            </li>
            <li className="flex gap-4">
      ...
      <section className="mt-12 p-8 rounded-2xl border border-zinc-800 bg-zinc-900/30">
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <Link href="/docs/client-sdk" className="text-teal-500 font-bold text-sm uppercase tracking-widest hover:underline">
