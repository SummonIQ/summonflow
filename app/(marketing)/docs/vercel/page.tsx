    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-[11px] leading-relaxed">
          ...
          <div className="px-8 text-zinc-300">secret: process.env.SUMMONFLOW_APP_SECRET!,</div>
      ...
      <section className="space-y-6 mt-12">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-xs space-y-1">
          ...
          <div className="text-zinc-300">SUMMONFLOW_PUBLISH_TOKEN=<span className="text-teal-400">your-publish-token</span></div>
        </div>
      </section>
    </article>
  );
