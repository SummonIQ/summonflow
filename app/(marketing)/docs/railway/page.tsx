    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="space-y-6 mt-12">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-xs">
          ...
          <div className="text-zinc-500 italic"># Install the socket server package and deploy</div>
          <div className="text-teal-400">bun add your-summonflow-server-package</div>
      ...
      <section className="space-y-6 mt-12">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-xs space-y-1">
          <div className="text-zinc-300">SUMMONFLOW_APP_KEY=<span className="text-teal-400">your-app-key</span></div>
          <div className="text-zinc-300">SUMMONFLOW_APP_SECRET=<span className="text-teal-400">your-app-secret</span></div>
      ...
      <section className="space-y-6 mt-12">
        ...
        <p className="text-zinc-400">
          Don&apos;t want to manage Railway yourself? The <Link href="/signup" className="text-teal-500 hover:underline">managed platform</Link> handles all of this for you — just create an app and start connecting.
        </p>
      </section>
    </article>
  );
