    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-4 text-zinc-400">
          ...
          <li><strong className="text-zinc-200">Zero Lock-in:</strong> Open-source client and server packages for self-hosted deployments.</li>
          <li><strong className="text-zinc-200">Control Plane:</strong> A managed console to manage keys, environments, and channel policies.</li>
      ...
      <section className="mt-12 rounded-xl border border-zinc-800 bg-zinc-900/30 p-6">
        <h2 className="text-lg font-bold text-white mb-4">Open-Source Surface</h2>
      ...
      <section className="mt-12 p-8 rounded-2xl border border-teal-500/20 bg-teal-500/5">
        ...
        <Link
          ...
          className="button-default inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-bold text-zinc-950 transition-colors"
        >
