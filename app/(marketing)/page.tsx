...
export const metadata: Metadata = {
  ...
  description:
    "Open source realtime infrastructure with channels, presence, end-to-end encryption, and a control plane you own. Self-host or use managed. TypeScript SDK.",
  alternates: { canonical: "https://summonflow.com" },
};
...
export default function MarketingHome() {
  return (
    <main className="page-shell min-h-screen">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 pt-28 sm:px-10">
        {/* Hero */}
        <section className="relative pb-8 lg:min-h-[calc(100svh-5.5rem)]">
          <div className="relative z-10 grid items-start gap-14 lg:min-h-[calc(100svh-10rem)] lg:grid-cols-[minmax(0,0.92fr)_minmax(25rem,0.88fr)]">
            <div className="fade-up -mt-10 relative max-w-3xl pb-1">
        ...
        <section className="relative pt-20 pb-16">
          ...
          <h3 className="mt-3 max-w-2xl text-sm leading-7 text-[var(--muted)]">
