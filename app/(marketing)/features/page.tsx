...
export const metadata: Metadata = {
  title: "Features",
  description:
    "SummonFlow features — public, private, and encrypted channels, presence tracking, Redis fanout, webhooks, TypeScript SDK, and a real control plane.",
  alternates: { canonical: "https://summonflow.com/features" },
};
