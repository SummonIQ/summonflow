...
export type AccountOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"accessToken" | "accessTokenExpiresAt" | "accountId" | "createdAt" | "id" | "idToken" | "password" | "providerId" | "refreshToken" | "refreshTokenExpiresAt" | "scope" | "updatedAt" | "userId", ExtArgs["result"]["account"]>
...
export interface AccountDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const accountWithAccessTokenOnly = await prisma.account.findMany({ select: { accessToken: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Accounts and only return the `accessToken`
   * const accountWithAccessTokenOnly = await prisma.account.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Accounts and only return the `accessToken`
   * const accountWithAccessTokenOnly = await prisma.account.updateManyAndReturn({
   *   select: { accessToken: true },
   *   where: {
   *     // ... provide filter here
   *   },
