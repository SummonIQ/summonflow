...
export default function SettingsPage() {
  ...
  return (
    <main className="space-y-8">
      ...
      <nav className="flex gap-1 rounded-lg border border-zinc-800/50 bg-zinc-900/30 p-1 w-fit">
        {tabs.map((tab) => (
          <button
            key={tab.id}
      ...
      <form onSubmit={handleSave} className="rounded-xl border border-zinc-800/50 bg-zinc-900/30 p-6 space-y-6">
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-2 rounded-lg bg-teal-500 px-4 py-2.5 text-sm font-semibold text-zinc-950 transition hover:bg-teal-400 disabled:opacity-60"
          >
  ...
  return (
    <div className="rounded-xl border border-zinc-800/50 bg-zinc-900/30 p-6 space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        ...
        <button type="submit" disabled={saving} className="inline-flex items-center gap-2 rounded-lg bg-teal-500 px-4 py-2.5 text-sm font-semibold text-zinc-950 transition hover:bg-teal-400 disabled:opacity-60">
      ...
      {subscription && (
        <footer className="flex items-center justify-between rounded-xl border border-dashed border-zinc-800 p-5">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-zinc-500">View invoices and update billing details.</span>
          </div>
