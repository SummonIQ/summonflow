    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="space-y-6">
        ...
        <p className="text-zinc-400">
          SummonStream uses a **stateless auth flow**. When a client attempts to subscribe to a `private-` or `presence-` channel, it must provide a signature from your backend.
        </p>
      ...
      <section className="space-y-6 mt-12">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 font-mono text-[11px] leading-relaxed">
          ...
          <div className="text-blue-400">import <span className="text-zinc-300">{"{ signSubscription }"}</span> from <span className="text-teal-400">'@summoniq/summon-stream-server'</span>;</div>
          <br/>
