import { ArrowRight, BookOpen, Code2, ShieldCheck, Zap } from "lucide-react";
    ...
    <article className="prose prose-invert max-w-none">
      <header className="mb-12">
        ...
        <p className="mt-4 text-xl text-zinc-400 leading-relaxed">
          SummonStream is a self-hosted realtime infrastructure designed for teams that want full control over their channel layer without sacrificing the operator experience.
        </p>
      </header>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-white border-b border-zinc-800 pb-2">Why SummonStream?</h2>
        <p className="text-zinc-400">
          Most realtime providers treat the channel layer as a black box. You pay for "connections" and "messages" without visibility into how the orchestration actually works. SummonStream flips this model.
        </p>
        <ul className="list-disc pl-6 space-y-4 text-zinc-400">
          <li><strong>Explicit Infrastructure:</strong> Deploy to Railway, Cloudflare, or your own metal.</li>
          <li><strong>Zero Lock-in:</strong> MIT licensed core runtime and client SDKs.</li>
          <li><strong>Control Plane:</strong> A professional console to manage keys, environments, and channel policies.</li>
        </ul>
      </section>
      ...
      <section className="mt-12 p-8 rounded-2xl border border-teal-500/20 bg-teal-500/5">
        ...
        <p className="text-zinc-400 mb-6 text-sm">
          Get SummonStream running in under 5 minutes with our Railway template.
        </p>
        <Link 
