      ...
      <aside className="fixed inset-y-0 left-0 w-72 border-r border-zinc-800/50 bg-zinc-950/50 backdrop-blur-xl">
        <div className="flex h-full flex-col px-6 py-8">
          ...
          <div className="flex items-center gap-3 px-2 mb-10">
            ...
            <span className="text-lg font-semibold tracking-tight text-white uppercase tracking-widest">SummonStream</span>
          </div>
          ...
          <div className="mt-8 border-t border-zinc-800/50 pt-6">
            <div className="rounded-xl border border-dashed border-zinc-800 bg-zinc-900/30 p-4">
              ...
              <div className="mt-4 flex gap-3">
                <button className="text-[11px] font-bold text-teal-500 uppercase tracking-widest hover:underline">GitHub</button>
                <button className="text-[11px] font-bold text-teal-500 uppercase tracking-widest hover:underline">Discord</button>
              </div>
            </div>
          </div>
        </div>
