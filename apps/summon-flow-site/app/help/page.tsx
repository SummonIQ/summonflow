...
import { BookOpen, Github, MessageCircle, Mail, FileText, Zap } from "lucide-react";
...
const resources = [
  ...
  },
  {
    icon: Github,
    title: "GitHub Issues",
    description: "Report bugs, request features, or browse existing issues on the open source repo.",
    href: "https://github.com/SummonIQ/summonflow/issues",
    cta: "Open an issue",
    external: true,
  },
  {
    ...
    description: "Ask questions, share what you're building, or help others in the community.",
    href: "https://github.com/SummonIQ/summonflow/discussions",
    cta: "Join discussion",
    external: true,
  },
  {
